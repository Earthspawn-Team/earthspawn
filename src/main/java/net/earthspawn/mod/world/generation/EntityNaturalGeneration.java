...
public class EntityNaturalGeneration {
    ...
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToSpecificBiomes(event, EntityRegister.OULISK.get(), 15, 2, 5, BiomeRegister.HALLOW_LANDS.getKey());
        addEntityToSpecificBiomes(event, EntityRegister.ACPHINES.get(), 10, 4, 8, BiomeRegister.HALLOW_LANDS.getKey());
        addEntityToSpecificBiomes(event, EntityRegister.GOBLIN.get(), 10, 2, 6, BiomeRegister.HALLOW_LANDS.getKey());
    }
